    ...
    let books = this.state.books.map((book) => {
      return (
        <tr key={book.id}>
          ...
          <td>{book.rating}</td>
          <td>
            <Button color="success" size="sm" style={{marginRight:"4px"}} onClick={this.editBook.bind(this, book.id, book.title, book.rating)}>Edit</Button>
            <Button color="danger" size="sm"  style={{marginLeft:"4px"}}onClick={this.deleteBook.bind(this, book.id)}>Delete</Button>
          </td>
        </tr>
      )
    });
